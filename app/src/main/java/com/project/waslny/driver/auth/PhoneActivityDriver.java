package com.project.waslny.driver.auth;
        ...
        if (cancel){
            ...
            new CountDownTimer(45000, 1000) {
                ...
                public void onFinish() {
                    timer.setText(0 + " s");
                    resendCode.startAnimation(AnimationUtils.loadAnimation(PhoneActivityDriver.this, R.anim.slide_from_right));
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Intent i = new Intent(PhoneActivityDriver.this,DriverMapActivity.class);
                            startActivity(i);
                            ...
                            if (task.getException() instanceof FirebaseAuthInvalidCredentialsException) {
                                ...
                                Toast.makeText(PhoneActivityDriver.this,"Invalid Verification Code",Toast.LENGTH_LONG).show();
                            }
                        }
                    }
                });
