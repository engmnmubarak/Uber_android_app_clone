...
public class CustomerSignInActivity extends AppCompatActivity {
    ...
    private static final String TAG = "CustomerSignInActivity";
    private Context mContext = CustomerSignInActivity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firebaseAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if(user!=null){
                    Intent intent = new Intent(CustomerSignInActivity.this, CustomerMapActivity.class);
        ...
        linkSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(mContext, CustomerSignUpActivity.class);
                startActivity(intent);
            }
        });
