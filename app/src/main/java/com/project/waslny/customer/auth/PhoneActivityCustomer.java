package com.project.waslny.customer.auth;
...
public class PhoneActivityCustomer extends AppCompatActivity {
...
// [END initialize_auth]
        ...
        if (cancel){
            ...
            new CountDownTimer(45000, 1000) {
                ...
                public void onFinish() {
                    timer.setText(0 + " s");
                    resendCode.startAnimation(AnimationUtils.loadAnimation(PhoneActivityCustomer.this, R.anim.slide_from_right));
    ...
    private void startPhoneNumberVerification(String phoneNumber) {
        ...
        *
        *
        * To initiate phone number sign-in, present the user an interface that prompts them to type
        * their phone number. Legal requirements vary, but as a best practice and to set expectations
        * for your users, you should inform them that if they use phone sign-in, they might receive
        * an SMS message for verification and standard rates apply.

          Then, pass their phone number to the PhoneAuthProvider.verifyPhoneNumber method to request
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Intent i = new Intent(PhoneActivityCustomer.this,CustomerMapActivity.class);
                            startActivity(i);
                            ...
                            if (task.getException() instanceof FirebaseAuthInvalidCredentialsException) {
                                ...
                                Toast.makeText(PhoneActivityCustomer.this,"Invalid Verification Code",Toast.LENGTH_LONG).show();
                            }
                        }
                    }
                });
